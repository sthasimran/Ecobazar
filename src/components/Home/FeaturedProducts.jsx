          ...
          {data.featuredData.map((item, index) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 flex flex-col justify-between">
                ...
                <div className="absolute bottom-8 right-4  w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center hover:bg-primary hover:text-white group-hover/edit:bg-slate-400">
