      ...
      <div className="flex justify-center items-center h-screen ">
        <div className="p-6 shadow-lg rounded-md w-[520px] bg-white ">
          ...
          <div className="flex flex-col gap-[16px]">
            ...
            <div>
              <label for="confirmPassword mb-2"></label>
              <div className="relative">
                <input
                  type={showPassword ? "text" : "password"}
                  id="password"
            ...
            <div className="">
                ...
                <label for="remember" className="">Accept all terms & conditions</label>
              
              
            </div>
          </div>
          <div className="my-4">
            <Button className="w-full bg-primary rounded-full hover:bg-transparent hover:text-[#1A1A1A] ">Create Account</Button>
          </div>
